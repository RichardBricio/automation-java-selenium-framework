...
public class SerajaJudOrdensPage {

	public SerajaJudOrdensPage() {
...
//
//	driver.get("https://experian-serasajud-front-br-serasajud-qa-ext.f.apps.experian.com/listar-ordem");
