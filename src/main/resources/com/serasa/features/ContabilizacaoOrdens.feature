@Contabilizacao
Feature: Contabilização de Ordens Cadastradas

	@test
	Scenario: Pré Requisito - Acessar produto SerasaJud
		Given Que eu esteja usando o browser CHROME
		Given Que eu acesso a pagina de login no ambiente de EXT
		And Eu seleciono o primeiro CERTIFICADO_DIGITAL e insiro a senha "serasa@1"
